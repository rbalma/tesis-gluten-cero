          ...
          >
            <Row gutter={24}>
              <Col sm={12} xs={24}>
                ...
                >
                  <Input prefix={<UserOutlined className='margin-icon' />} placeholder="Nombre" />
                </Form.Item>
              </Col>
              ...
              <Col sm={12} xs={24}>
                ...
                >
                  <Input prefix={<UserOutlined className='margin-icon' />} placeholder="Apellido" />
                </Form.Item>
              </Col>
            </Row>
            ...
            >
              <Input prefix={<MailOutlined className='margin-icon' />} placeholder="Correo electrónico" />
            </Form.Item>
            ...
            >
              <Input.Password prefix={<LockOutlined className='margin-icon' />} placeholder="Contraseña" />
            </Form.Item>
            ...
            >
              <Input.Password prefix={<LockOutlined className='margin-icon' />} placeholder="Confirmar contraseña" />
            </Form.Item>
