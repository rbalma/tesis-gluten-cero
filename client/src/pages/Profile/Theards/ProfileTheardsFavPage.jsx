...
import { ProfileLikeThreadsCard } from '@/components/Profile/Cards';
...
export const ProfileTheardsFavPage = () => {
  const userProfile = useAuthStore((state) => state.userProfile);
	const { data, isLoading, isSuccess } = useGetThreads({ likedBy: userProfile.id });
  
	return (
		<div className={styles.profileContainer}>
			<header className={styles.profileHeader}>
				<h1>Hilos Favoritos</h1>
				<Breadcrumb
