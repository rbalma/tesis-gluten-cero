	...
	return (
		<section className={styles.sectionBg}>
			<header className={styles.header}>
				<h3>
					Increíbles <span>Servicios</span>
				</h3>
				<p>
			...
			<Fade cascade direction='up' damping={0.3} triggerOnce>
				<div className={styles.flexboxCards}>
					<div className={styles.box}>
						...
						<p className={styles.description}>
							Recetas sin tacc organizadas por categorías donde cada usuario
							podrá crear su propia receta para ser compartida con todos los que
				...
				<div className={styles.flexboxCards}>
					<div className={styles.box} style={{ maxWidth: 600 }}>
						<div className={styles.icon}>
							<RobotOutlined
								className={styles.iconAntd}
								style={{ color: '#4680ff' }}
